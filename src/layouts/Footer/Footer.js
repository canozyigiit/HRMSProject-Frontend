...
export default function Footer() {
	...
	const getAllCityId = (city) => {
		jobAdvertService.getAllisOpenTrueAndCityId(city.id)
	};
					...
					<div className="col-sm-6 col-md-4 col-md-3 col-lg-2">
						<div className="quick_link_widget">
							...
							<ul className="list-unstyled">
								...
								<Link to="/postJob"><li><a href=" ">İlan Ver<i className="flaticon-right-arrow pl15"></i></a></li></Link>
							</ul>
						</div>
					</div>
						...
						<div className="candidate_widget">
							...
							<ul className="list-unstyled">
								{cities.slice(0, 5).map((city) => (
									<Link to="/jobAdverts"><li onClick={() => getAllCityId(city)} key={city.id}  ><a >- {city.name}<i className="flaticon-right-arrow pl15"></i></a></li></Link>
